...
public class HandlerWithAutomaticPriming implements RequestHandler<Map<String, String>, String>, Resource {

    private final MetricsLogger metricsLogger = new MetricsLogger();
    private final Logger logger = LoggerFactory.getLogger(HandlerWithAutomaticPriming.class);

    public HandlerWithAutomaticPriming() {
    ...
    public void beforeCheckpoint(org.crac.Context<? extends Resource> context) throws Exception {
        logger.info("Before preloading");
        ClassPreLoader.preloadClasses(true);
        logger.info("After preloading");
    }
